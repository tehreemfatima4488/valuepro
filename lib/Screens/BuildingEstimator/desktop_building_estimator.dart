...
class DesktopBuildingEstimator extends StatefulWidget {
  @override
  _DesktopBuildingEstimatorState createState() =>
      _DesktopBuildingEstimatorState();
}

class _DesktopBuildingEstimatorState extends State<DesktopBuildingEstimator> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          'Construction Cost Calculator - Desktop',
